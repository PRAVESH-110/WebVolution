...
export default function Navbar() {
    return (
        <nav className="fixed gap-2 z-[1000] flex justify-between items-center mt-2 mx-2 px-8 py-2 bg-white/5 backdrop-blur-md border-white-50 border-2 rounded-full transition-all duration-300 dark:bg-black/20 dark:border-white/5">
            ...
            <Link href="/get-started" className="bg-[var(--foreground)] text-[var(--background)] px-5 py-2 rounded-full font-semibold text-sm transition-transform duration-200 shadow-sm hover:scale-105 hover:shadow-lg decoration-0">
                Get Score
            </Link>
        </nav>
    );
